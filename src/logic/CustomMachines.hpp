...
public:
    ...
    void draw() override {
        GraphicsEngine::instance()->drawBitmap(rect.p1,  GraphicsEngine::instance()->image, 0);
        Machine::draw();
    }
};
...
public:
    ...
    void draw() override {
        Machine::draw();
        GraphicsEngine::instance()->drawLine(Point2d(rect.p1.x, rect.p2.y + 10), Point2d(rect.p1.x + (period - cooldown) / 4, rect.p2.y + 10), 5, al_map_rgb(100, 100, 100), 2);
        GraphicsEngine::instance()->drawLine(Point2d(rect.p1.x, rect.p2.y + 10), Point2d(rect.p1.x + (period - cooldown) / 4, rect.p2.y + 10), 0, al_map_rgb(255, 255, 255), 2);
    }
...
public:
    ...
    void draw() override {
        ...
        GraphicsEngine::instance()->drawLine(Point2d(rect.p1.x, rect.p2.y + 10), Point2d(rect.p1.x + processTime, rect.p2.y + 10), 10, al_map_rgb(255, 255, 255), 2);
    }
};
